...
const monthlyData2024 = [
    { month: "January", services: 45 },
    { month: "February", services: 100 },
    { month: "March", services: 150 },
    { month: "April", services: 50 },
    { month: "May", services: 100 },
    { month: "June", services: 160 },
    { month: "July", services: 120 },
    { month: "August", services: 135 },
    { month: "September", services: 150 },
    { month: "October", services: 180 },
    { month: "November", services: 200 },
    { month: "December", services: 230 },
]
...
export function ServiceOverviewChart() {
                ...
                return (
                    ...
                    >
                        ...
                        <Line
                            ...
                            strokeWidth={2}
                            dot={{ r: 4, strokeWidth: 0, fill: chartConfig.services.color }}
                    ...
                    >
                        <defs>
                            <linearGradient id="colorServices" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor={chartConfig.services.color} stopOpacity={0.8} />
                                <stop offset="95%" stopColor={chartConfig.services.color} stopOpacity={0.1} />
                            </linearGradient>
                        </defs>
                        <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="hsl(var(--border))" />
                        <XAxis
            ...
            case "bar":
                return (
                    ...
                    >
                        ...
                        <Bar
                            dataKey="services"
                            fill={chartConfig.services.color}
                            radius={[4, 4, 0, 0]}
                            maxBarSize={40}
                        />
                    </BarChart>
        ...
        <Card className="shadow-sm">
            <CardHeader className="pb-3">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                    <div>
                        <CardTitle className="text-lg font-bold">Services Analytics Overview</CardTitle>
                        <CardDescription className="text-sm text-muted-foreground">
                            {chartType === "line" ? "Line" :
                                chartType === "area" ? "Area" :
                                    chartType === "bar" ? "Bar" : "Stacked Area"} Chart showing services performance
                        </CardDescription>
                    </div>
